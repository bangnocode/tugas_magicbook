...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<int> input = [1, 2, 3, 4, 5];
      Map<String, int> output = {for (var i in input) 'number': i};
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, int> output = {
        'apple':
            input[0]['apple'] ?? 0 // Mengambil nilai "apple" dari map pertama
      };
      // --- End of Answer ---
    ...
    () {
      ...
      for (var item in input) {
        if (item.containsKey('fruit')) {
          output.add(item['fruit'].toString());
        }
      }
    ...
    () {
      ...
      List<String> inputList = input.split(',');
      for (var value in inputList) {
        output.add(DateTime.parse(value));
      }
      // --- End of Answer ---
    ...
    */
    ...
    () {
      ...
      int? output = RegExp('a').allMatches(text).length;
      return output == 2;
    },
    ...
    () {
      ...
      int? output = RegExp('x').allMatches(text).length;
      return output == 0;
    },
    ...
    () {
      ...
      int? output = RegExp('[aA]').allMatches(text).length;
      return output == 2;
    },
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      // Implementasikan kode untuk memeriksa apakah semua angka pada List numbers adalah angka positif (lebih besar dari 0).
      bool output = numbers.every((n) => n > 0);
      return output;
    },
    ...
    () {
      ...
      bool output = numbers.any((n) => n % 2 == 0);
      return output;
    },
    ...
    () {
      ...
      int output = numbers.firstWhere((n) => n % 2 == 0, orElse: () => -1);
      return output == 2;
    },
    ...
    () {
      ...
      int output = numbers.indexWhere((n) => n % 2 == 0);
      return output == 1;
    },
    ...
    () {
      ...
      numbers.remove(numbers.firstWhere((n) => n % 2 == 0));
    ...
    () {
      ...
      numbers = numbers.map((n) => n * 2).toList();
    ...
    () {
      ...
      for (var fruit in fruits) {
        if (fruit == 'kiwi') {
          output = true;
          break; // Exit the loop once 'kiwi' is found
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (var transaction in data) {
        if (transaction["isPromo"] == true &&
          ...
          totalPromoSales += transaction["amount"];
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (var transaction in data) {
        if (transaction["category"] == "Electronics" &&
            transaction["transaction"] == "Sale") {
          totalElectronicsSales += transaction["amount"];
        }
      }
      // --- End of Answer ---
